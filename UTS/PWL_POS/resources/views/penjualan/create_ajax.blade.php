                ...
                <table class="table" id="detailTable">
                    <thead>
                        <tr>
                            ...
                            <th class="col-3">Harga (Otomatis)</th>
...
$(document).ready(function () {
    ...
    function addDetailRow() {
        ...
        <td>
            ...
            <input type="hidden" name="details[${detailIndex}][harga]" class="harga-input" required>
    ...
    $('#detailTable').on('change', '.barang-select', function () {
        ...
        row.find('.harga-display').val(formatRupiah(totalHarga));
        row.find('.harga-input').val(totalHarga);
    });
